...
-- Tablas seleccionadas: _respaldo_jugadores,arbitro,asistencias,cantidad_partidos_arbitros,clasificacion,detalles_partidos,detalle_patrocinios,directivo,disputa,draft,empleado
...
--
-- Table structure for table `_respaldo_jugadores`
--
...
CREATE TABLE `_respaldo_jugadores` (
  ...
  `nombre_jugador` varchar(30) DEFAULT NULL,
  `apellido_jugador` varchar(30) DEFAULT NULL,
...
CREATE TABLE `arbitro` (
  ...
  KEY `id_liga` (`id_liga`),
  CONSTRAINT `arbitro_ibfk_1` FOREIGN KEY (`id_liga`) REFERENCES `liga` (`id_liga`)
...
CREATE TABLE `asistencias` (
  ...
  CONSTRAINT `asistencias_ibfk_1` FOREIGN KEY (`id_jugador`) REFERENCES `jugador` (`id_jugador`),
  CONSTRAINT `asistencias_ibfk_2` FOREIGN KEY (`id_partido`) REFERENCES `partido` (`id_partido`)
...
--
-- Temporary view structure for view `cantidad_partidos_arbitros`
--

DROP TABLE IF EXISTS `cantidad_partidos_arbitros`;
/*!50001 DROP VIEW IF EXISTS `cantidad_partidos_arbitros`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `cantidad_partidos_arbitros` AS SELECT 
 1 AS `Nombre_Arbitro`,
 1 AS `Cantidad_Partidos`*/;
...
CREATE TABLE `clasificacion` (
  ...
  CONSTRAINT `clasificacion_ibfk_1` FOREIGN KEY (`id_equipo`) REFERENCES `equipo` (`id_equipo`)
...
--
-- Temporary view structure for view `detalle_partidos`
--

DROP TABLE IF EXISTS `detalle_partidos`;
/*!50001 DROP VIEW IF EXISTS `detalle_partidos`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `detalle_partidos` AS SELECT 
 1 AS `Equipos`,
 1 AS `Goles_Partido`,
 1 AS `Fecha`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `detalle_patrocinios`
--

DROP TABLE IF EXISTS `detalle_patrocinios`;
/*!50001 DROP VIEW IF EXISTS `detalle_patrocinios`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `detalle_patrocinios` AS SELECT 
 1 AS `Equipo`,
 1 AS `Patrocinador`,
 1 AS `Dinero_Invertido`*/;
SET character_set_client = @saved_cs_client;
...
CREATE TABLE `directivo` (
  ...
  KEY `id_liga` (`id_liga`),
  CONSTRAINT `directivo_ibfk_1` FOREIGN KEY (`id_liga`) REFERENCES `liga` (`id_liga`)
...
CREATE TABLE `disputa` (
  ...
  CONSTRAINT `disputa_ibfk_1` FOREIGN KEY (`id_partido`) REFERENCES `partido` (`id_partido`),
  CONSTRAINT `disputa_ibfk_2` FOREIGN KEY (`id_local`) REFERENCES `equipo` (`id_equipo`),
  CONSTRAINT `disputa_ibfk_3` FOREIGN KEY (`id_visitante`) REFERENCES `equipo` (`id_equipo`)
...
CREATE TABLE `draft` (
  ...
  `id_split` int DEFAULT NULL,
  PRIMARY KEY (`id_draft`),
  KEY `id_split` (`id_split`),
  CONSTRAINT `draft_ibfk_1` FOREIGN KEY (`id_split`) REFERENCES `split` (`id_split`)
...
CREATE TABLE `empleado` (
  ...
  KEY `id_liga` (`id_liga`),
  CONSTRAINT `empleado_ibfk_1` FOREIGN KEY (`id_liga`) REFERENCES `liga` (`id_liga`)
...
CREATE TABLE `equipo` (
  ...
  `enlace_escudo` varchar(1000) DEFAULT NULL,
  `id_presidente` int DEFAULT NULL,
  `id_liga` int DEFAULT NULL,
  PRIMARY KEY (`id_equipo`),
  KEY `id_presidente` (`id_presidente`),
  KEY `id_liga` (`id_liga`),
  CONSTRAINT `equipo_ibfk_1` FOREIGN KEY (`id_presidente`) REFERENCES `presidente` (`id_presidente`),
  CONSTRAINT `equipo_ibfk_2` FOREIGN KEY (`id_liga`) REFERENCES `liga` (`id_liga`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Temporary view structure for view `estadisticas_jugadores`
--

DROP TABLE IF EXISTS `estadisticas_jugadores`;
/*!50001 DROP VIEW IF EXISTS `estadisticas_jugadores`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `estadisticas_jugadores` AS SELECT 
 1 AS `Nombre`,
 1 AS `Cantidad_Goles`,
...
CREATE TABLE `goles` (
  ...
  KEY `id_jugador` (`id_jugador`),
  KEY `id_partido` (`id_partido`),
  CONSTRAINT `goles_ibfk_1` FOREIGN KEY (`id_jugador`) REFERENCES `jugador` (`id_jugador`),
  CONSTRAINT `goles_ibfk_2` FOREIGN KEY (`id_partido`) REFERENCES `partido` (`id_partido`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `jugador` (
  ...
  `fecha_nacimiento` date DEFAULT NULL,
  `franquicia` tinyint(1) DEFAULT NULL,
  `id_equipo` int DEFAULT NULL,
  `id_draft` int DEFAULT NULL,
  PRIMARY KEY (`id_jugador`),
  KEY `id_equipo` (`id_equipo`),
  KEY `id_draft` (`id_draft`),
  CONSTRAINT `jugador_ibfk_1` FOREIGN KEY (`id_equipo`) REFERENCES `equipo` (`id_equipo`),
  CONSTRAINT `jugador_ibfk_2` FOREIGN KEY (`id_draft`) REFERENCES `draft` (`id_draft`)
...
--
-- Temporary view structure for view `jugadores_franquicia`
--

DROP TABLE IF EXISTS `jugadores_franquicia`;
/*!50001 DROP VIEW IF EXISTS `jugadores_franquicia`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `jugadores_franquicia` AS SELECT 
 1 AS `Nombre_Jugador_Franquicia`,
 1 AS `Equipo`*/;
SET character_set_client = @saved_cs_client;
...
CREATE TABLE `liga` (
  ...
  `nombre` varchar(20) DEFAULT NULL,
  `enlace_logo` varchar(1000) DEFAULT NULL,
  PRIMARY KEY (`id_liga`)
...
CREATE TABLE `partido` (
  ...
  CONSTRAINT `partido_ibfk_1` FOREIGN KEY (`id_arbitro`) REFERENCES `arbitro` (`id_arbitro`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `patrocinador` (
  ...
  `nombre` varchar(30) DEFAULT NULL,
  `dinero_invertido` decimal(10,0) DEFAULT NULL,
  `id_equipo` int DEFAULT NULL,
  PRIMARY KEY (`id_patrocinador`),
  KEY `id_equipo` (`id_equipo`),
  CONSTRAINT `patrocinador_ibfk_1` FOREIGN KEY (`id_equipo`) REFERENCES `equipo` (`id_equipo`)
...
CREATE TABLE `reglas` (
  ...
  KEY `id_liga` (`id_liga`),
  CONSTRAINT `reglas_ibfk_1` FOREIGN KEY (`id_liga`) REFERENCES `liga` (`id_liga`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `split` (
  ...
  `fecha_inicio` date DEFAULT NULL,
  `fecha_fim` date DEFAULT NULL,
  `id_campeon` int DEFAULT NULL,
  `id_liga` int DEFAULT NULL,
  PRIMARY KEY (`id_split`),
  KEY `id_liga` (`id_liga`),
  KEY `id_campeon` (`id_campeon`),
  CONSTRAINT `split_ibfk_1` FOREIGN KEY (`id_liga`) REFERENCES `liga` (`id_liga`),
  CONSTRAINT `split_ibfk_2` FOREIGN KEY (`id_campeon`) REFERENCES `equipo` (`id_equipo`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `staff` (
  ...
  KEY `id_equipo` (`id_equipo`),
  CONSTRAINT `staff_ibfk_1` FOREIGN KEY (`id_equipo`) REFERENCES `equipo` (`id_equipo`)
) ENGINE=InnoDB AUTO_INCREMENT=49 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Final view structure for view `cantidad_partidos_arbitros`
--
...
/*!50001 VIEW `cantidad_partidos_arbitros` AS select concat(`a`.`nombre`,' ',`a`.`apellido`) AS `Nombre_Arbitro`,count(`p`.`id_arbitro`) AS `Cantidad_Partidos` from (`arbitro` `a` join `partido` `p` on((`a`.`id_arbitro` = `p`.`id_arbitro`))) group by `a`.`id_arbitro` order by `Cantidad_Partidos` desc */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `detalle_partidos`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `detalle_partidos` AS select concat(`l`.`nombre`,'-',`v`.`nombre`) AS `Equipos`,concat(`p`.`goles_local`,'-',`p`.`goles_visitante`) AS `Goles_Partido`,`p`.`fecha` AS `Fecha` from (((`partido` `p` join `disputa` `d` on((`p`.`id_partido` = `d`.`id_partido`))) join `equipo` `l` on((`d`.`id_local` = `l`.`id_equipo`))) join `equipo` `v` on((`d`.`id_visitante` = `v`.`id_equipo`))) order by `p`.`fecha` desc */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `detalle_patrocinios`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `detalle_patrocinios` AS select `e`.`nombre` AS `Equipo`,`p`.`nombre` AS `Patrocinador`,concat('€ ',`p`.`dinero_invertido`) AS `Dinero_Invertido` from (`equipo` `e` join `patrocinador` `p` on((`e`.`id_equipo` = `p`.`id_equipo`))) order by `p`.`dinero_invertido` desc */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `estadisticas_jugadores`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `estadisticas_jugadores` AS select concat(`j`.`nombre`,' ',`j`.`apellido`) AS `Nombre`,ifnull(`g`.`cantidad_goles`,0) AS `Cantidad_Goles`,ifnull(`a`.`cantidad_asistencias`,0) AS `Cantidad_Asistencias`,`e`.`nombre` AS `Equipo` from (((`jugador` `j` left join (select `goles`.`id_jugador` AS `id_jugador`,count(0) AS `cantidad_goles` from `goles` group by `goles`.`id_jugador`) `g` on((`j`.`id_jugador` = `g`.`id_jugador`))) left join (select `asistencias`.`id_jugador` AS `id_jugador`,count(0) AS `cantidad_asistencias` from `asistencias` group by `asistencias`.`id_jugador`) `a` on((`j`.`id_jugador` = `a`.`id_jugador`))) join `equipo` `e` on((`e`.`id_equipo` = `j`.`id_equipo`))) where ((`g`.`cantidad_goles` > 0) or (`a`.`cantidad_asistencias` > 0)) order by `g`.`cantidad_goles` desc */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `jugadores_franquicia`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `jugadores_franquicia` AS select concat(`j`.`nombre`,' ',`j`.`apellido`) AS `Nombre_Jugador_Franquicia`,`e`.`nombre` AS `Equipo` from (`jugador` `j` join `equipo` `e` on((`e`.`id_equipo` = `j`.`id_equipo`))) where (`j`.`franquicia` = 1) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2023-09-09  9:18:14
